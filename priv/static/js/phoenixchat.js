...
Elm.Phoenix.Socket = Elm.Phoenix.Socket || {};
Elm.Phoenix.Socket.make = function (_elm) {
   "use strict";
   _elm.Phoenix = _elm.Phoenix || {};
   _elm.Phoenix.Socket = _elm.Phoenix.Socket || {};
   if (_elm.Phoenix.Socket.values) return _elm.Phoenix.Socket.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var toString = $Native$Phoenix.socketToString;
   var disconnect = $Native$Phoenix.disconnect;
   var updateParams = $Native$Phoenix.updateParams;
   var tryConnect = $Native$Phoenix.tryConnect;
   var connect = $Native$Phoenix.connect;
   var onStateChange = F2(function (callback,options) {    return _U.update(options,{onStateChange: $Maybe.Just(callback)});});
   var params = F2(function (params,options) {    return _U.update(options,{params: $Maybe.Just(params)});});
   var longpollerTimeout = F2(function (timeout,options) {    return _U.update(options,{longpollerTimeout: $Maybe.Just(timeout)});});
   var logger = F2(function (destination,options) {    return _U.update(options,{logger: $Maybe.Just(destination)});});
   var reconnectAfterMs = F2(function (intervals,options) {    return _U.update(options,{reconnectAfterMs: intervals});});
   var heartbeatIntervalMs = F2(function (interval,options) {    return _U.update(options,{heartbeatIntervalMs: $Maybe.Just(interval)});});
   var transport = F2(function (transport,options) {    return _U.update(options,{transport: transport});});
   var Options = F8(function (a,b,c,d,e,f,g,h) {
      return {endPoint: a,transport: b,heartbeatIntervalMs: c,reconnectAfterMs: d,logger: e,longpollerTimeout: f,params: g,onStateChange: h};
   });
   var PerformTask = function (a) {    return {ctor: "PerformTask",_0: a};};
   var SendMessage = function (a) {    return {ctor: "SendMessage",_0: a};};
   var Disconnect = {ctor: "Disconnect"};
   var Ignore = {ctor: "Ignore"};
   var Error = function (a) {    return {ctor: "Error",_0: a};};
   var Closed = function (a) {    return {ctor: "Closed",_0: a};};
   var Open = {ctor: "Open"};
   var Unknown = {ctor: "Unknown"};
   var Mailbox = function (a) {    return {ctor: "Mailbox",_0: a};};
   var Console = {ctor: "Console"};
   var LogMessage = F3(function (a,b,c) {    return {kind: a,message: b,data: c};});
   var LongPoll = {ctor: "LongPoll"};
   var WebSocket = {ctor: "WebSocket"};
   var Auto = {ctor: "Auto"};
   var socket = function (endPoint) {
      return A8(Options,endPoint,Auto,$Maybe.Nothing,_U.list([]),$Maybe.Nothing,$Maybe.Nothing,$Maybe.Nothing,$Maybe.Nothing);
   };
   var Socket = {ctor: "Socket"};
   return _elm.Phoenix.Socket.values = {_op: _op
                                       ,socket: socket
                                       ,transport: transport
...
Elm.Phoenix = Elm.Phoenix || {};
Elm.Phoenix.Channel = Elm.Phoenix.Channel || {};
Elm.Phoenix.Channel.make = function (_elm) {
   "use strict";
   _elm.Phoenix = _elm.Phoenix || {};
   _elm.Phoenix.Channel = _elm.Phoenix.Channel || {};
   if (_elm.Phoenix.Channel.values) return _elm.Phoenix.Channel.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   $Maybe = Elm.Maybe.make(_elm),
   $Native$Phoenix = Elm.Native.Phoenix.make(_elm),
   $Phoenix$Socket = Elm.Phoenix.Socket.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var toString = $Native$Phoenix.channelToString;
   var leave = $Native$Phoenix.leave;
   var updateParams = $Native$Phoenix.updateChannelParams;
   var tryPush = $Native$Phoenix.tryPush;
   var push = $Native$Phoenix.push;
   var tryJoin = $Native$Phoenix.tryJoin;
   var join = $Native$Phoenix.join;
   var onStateChange = F2(function (callback,options) {    return _U.update(options,{onStateChange: $Maybe.Just(callback)});});
   var params = F2(function (params,options) {    return _U.update(options,{params: $Maybe.Just(params)});});
   var Timeout = {ctor: "Timeout"};
   var ErrorReply = function (a) {    return {ctor: "ErrorReply",_0: a};};
   var Options = F5(function (a,b,c,d,e) {    return {socket: a,topic: b,params: c,onStateChange: d,on: e};});
   var channel = F2(function (topic,socket) {    return A5(Options,socket,topic,$Maybe.Nothing,$Maybe.Nothing,_U.list([]));});
   var Hook = F2(function (a,b) {    return {event: a,callback: b};});
   var on = F3(function (event,callback,options) {    return _U.update(options,{on: A2($List._op["::"],A2(Hook,event,callback),options.on)});});
   var PerformTask = function (a) {    return {ctor: "PerformTask",_0: a};};
   var SendMessage = function (a) {    return {ctor: "SendMessage",_0: a};};
   var Leave = {ctor: "Leave"};
   var Reply = F2(function (a,b) {    return {ctor: "Reply",_0: a,_1: b};});
   var Ignore = {ctor: "Ignore"};
   var Error = function (a) {    return {ctor: "Error",_0: a};};
   var Left = {ctor: "Left"};
   var Rejected = function (a) {    return {ctor: "Rejected",_0: a};};
   var Joined = function (a) {    return {ctor: "Joined",_0: a};};
   var Unknown = {ctor: "Unknown"};
   var Channel = {ctor: "Channel"};
   return _elm.Phoenix.Channel.values = {_op: _op
                                        ,channel: channel
                                        ,params: params
                                        ,onStateChange: onStateChange
                                        ,on: on
...
Elm.PhoenixChat = Elm.PhoenixChat || {};
Elm.PhoenixChat.make = function (_elm) {
   "use strict";
   _elm.PhoenixChat = _elm.PhoenixChat || {};
   if (_elm.PhoenixChat.values) return _elm.PhoenixChat.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Phoenix$Channel = Elm.Phoenix.Channel.make(_elm),
   $Phoenix$Socket = Elm.Phoenix.Socket.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   ...
   var messageTemplate = function (message) {
      return A2($Html.p,
      _U.list([]),
      _U.list([A2($Html.a,_U.list([$Html$Attributes.href("#")]),_U.list([$Html.text(A2($Basics._op["++"],"[",A2($Basics._op["++"],message.user,"]")))]))
              ,$Html.text(A2($Basics._op["++"]," ",message.body))]));
   };
   ...
   var connect = function (endPoint) {    return $Phoenix$Socket.connect($Phoenix$Socket.socket(endPoint));};
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.id("messages"),$Html$Attributes.$class("container")]),
              A2($List.map,messageTemplate,$List.reverse(model.messages)))
              ,A2($Html.div,
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([A2($Html.span,_U.list([$Html$Attributes.$class("input-group-addon")]),_U.list([$Html.text("@")]))
                              ,A2($Html.input,
                              _U.list([$Html$Attributes.id("username")
                                      ,$Html$Attributes.type$("text")
                                      ,$Html$Attributes.$class("form-control")
                                      ,A2($Html$Attributes.attribute,"placeholder","username")
                                      ,A3($Html$Events.on,
                                      "input",
                                      $Html$Events.targetValue,
                                      function (_p1) {
                                         return A2($Signal.message,address,Username(_p1));
                                      })]),
                              _U.list([]))]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("col-sm-10")]),
                      _U.list([A2($Html.input,
                      _U.list([$Html$Attributes.id("message-input")
                              ,$Html$Attributes.$class("form-control")
                              ...
                              ,A2(onEnter,address,SubmitMessage)]),
                      _U.list([]))]))]))]))]))]));
   });
   var NewMessage = function (a) {    return {ctor: "NewMessage",_0: a};};
   var Channel = function (a) {    return {ctor: "Channel",_0: a};};
   var NoOp = {ctor: "NoOp"};
   var mailbox = $Signal.mailbox(NoOp);
   var Model = F4(function (a,b,c,d) {    return {channel: a,messages: b,username: c,field: d};});
   var Message = F2(function (a,b) {    return {user: a,body: b};});
   ...
   var newMessage = function (value) {
      var _p3 = A2($Json$Decode.decodeValue,messageDecoder,value);
      if (_p3.ctor === "Ok") {
            return $Phoenix$Channel.SendMessage(A2($Signal.message,mailbox.address,NewMessage(_p3._0)));
         } else {
            return $Phoenix$Channel.Leave;
         }
   };
   var join = F2(function (topic,socket) {
      return $Phoenix$Channel.join(A3($Phoenix$Channel.on,"new:msg",newMessage,A2($Phoenix$Channel.channel,topic,socket)));
   });
   var init = {ctor: "_Tuple2"
              ,_0: A4(Model,$Maybe.Nothing,_U.list([]),"","")
              ,_1: $Effects.task(A2($Task.map,Channel,A2($Task.andThen,connect("/socket"),join("rooms:lobby"))))};
   _op["=>"] = F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};});
   var encodeMessage = F2(function (user,body) {
      return $Json$Encode.object(_U.list([A2(_op["=>"],"user",$Json$Encode.string(user)),A2(_op["=>"],"body",$Json$Encode.string(body))]));
   });
   var update = F2(function (action,model) {
      var _p4 = action;
      switch (_p4.ctor)
      {case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "Channel": return {ctor: "_Tuple2",_0: _U.update(model,{channel: $Maybe.Just(_p4._0)}),_1: $Effects.none};
         case "NewMessage": return {ctor: "_Tuple2",_0: _U.update(model,{messages: A2($List._op["::"],_p4._0,model.messages)}),_1: $Effects.none};
         case "Username": return {ctor: "_Tuple2",_0: _U.update(model,{username: _p4._0}),_1: $Effects.none};
         case "UpdateField": return {ctor: "_Tuple2",_0: _U.update(model,{field: _p4._0}),_1: $Effects.none};
         default: var _p5 = model.channel;
           if (_p5.ctor === "Nothing") {
                 ...
                 return {ctor: "_Tuple2"
                        ...
                        $Basics.always(NoOp),
                        A3($Phoenix$Channel.push,"new:msg",A2(encodeMessage,model.username,model.field),_p5._0)))};
              }}
   });
   var app = $StartApp.start({init: init,view: view,update: update,inputs: _U.list([mailbox.signal])});
   var main = app.html;
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",app.tasks);
   return _elm.PhoenixChat.values = {_op: _op
                                    ,Message: Message
                                    ,Model: Model
                                    ,init: init
                                    ,NoOp: NoOp
